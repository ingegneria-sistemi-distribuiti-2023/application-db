...
# base build command: docker build -t application-db:0.02 -f Dockerfile --build-arg EXPOSED_PORT=3306 --build-arg MYSQL_ROOT_PASSWORD=root .
# run command: docker run -d -p 3306:3306 --name application-db -e MYSQL_ROOT_PASSWORD=root application-db:0.02
